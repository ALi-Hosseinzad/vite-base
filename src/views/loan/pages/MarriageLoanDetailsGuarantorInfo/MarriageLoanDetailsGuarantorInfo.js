...
const MarriageLoanDetailsGuarantorInfo = () => {
  ...
  const getInfo = () => {
    ...
    getMarriageLoanDetailsInfo(body, "guarantor")
      .then((res) => {
        const convertList = [];
        ...
        dispatch(
          marriageLoan({
            ...
            guarantorInfoMarriageTryAgain: false,
      ...
      .catch(() => {
        ...
        dispatch(marriageLoan({ guarantorInfoMarriageTryAgain: true }));
      });
  };
  ...
  const getImage = (key) => {
    ...
    dispatch(marriageLoan({ guarantorDocumentInfo: arr }));
    let params;
    if (record) {
      params = {
        reference_number: record.reference_number,
    ...
    getMarriageLoanDetailsImages(params)
      .then((res) => {
        ...
        dispatch(marriageLoan({ guarantorDocumentInfo: newArray }));
      })
      .catch(() => {
        const newArray = [...arr];
        newArray[index] = {
...
export default MarriageLoanDetailsGuarantorInfo;
